    ...
    <div class="pointer-events-auto relative mx-auto flex flex-col items-center gap-1.5">
      ...
      <PopoverRoot v-if="collabState.connected">
        ...
        <PopoverPortal>
          ...
          >
            <div class="mb-2 text-[12px] tracking-wider text-muted uppercase">In this room</div>
            <div class="flex flex-col gap-2">
              ...
              >
                ...
                <span v-if="followingPeer === peer.clientId" class="text-[11px] text-accent"
                  >following</span
                >
              </div>
            </div>
