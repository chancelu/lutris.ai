...
<template>
  <div v-if="node" data-test-id="typography-section" class="border-b border-border px-3 py-2">
    ...
    <div class="mb-1.5 flex gap-1.5">
      ...
      <TokenBindButton
        variable-type="FLOAT"
        :bound-variable-id="getBinding('fontSize')"
        @bind="bindField('fontSize', $event)"
        @unbind="unbindField('fontSize')"
      />
    </div>
    ...
    <div class="mb-1.5 flex gap-1.5">
      ...
      <TokenBindButton
        variable-type="FLOAT"
        :bound-variable-id="getBinding('lineHeight')"
        @bind="bindField('lineHeight', $event)"
        @unbind="unbindField('lineHeight')"
      />
      <ScrubInput
        class="flex-1"
        suffix="%"
      ...
      <TokenBindButton
        variable-type="FLOAT"
        :bound-variable-id="getBinding('letterSpacing')"
        @bind="bindField('letterSpacing', $event)"
        @unbind="unbindField('letterSpacing')"
      />
    </div>
