        ...
        <TooltipRoot>
          <TooltipTrigger as-child>
            <div
              ...
              class="flex size-6 items-center justify-center rounded-full border-2 border-panel text-[11px] font-semibold text-white"
        ...
        <TooltipRoot v-for="peer in peers" :key="peer.clientId">
          <TooltipTrigger as-child>
            <div
              ...
              class="flex size-6 cursor-pointer items-center justify-center rounded-full border-2 text-[11px] font-semibold text-white transition-all"
              :class="
    ...
    <PopoverRoot v-model:open="popoverOpen">
      <PopoverTrigger as-child>
        ...
        >
          ...
          {{ state.connected ? t('action.connected') : isJoining ? t('action.joining') : t('action.share') }}
        </button>
      </PopoverTrigger>
      ...
      <PopoverPortal>
        ...
        >
          ...
          <template v-else-if="isJoining">
            ...
            <div class="mb-3 text-[12px] text-muted">
          ...
          <template v-else>
            ...
            <div class="mb-2 flex items-center gap-2">
              ...
              <span class="text-[12px] text-muted">or join a room</span>
              <div class="h-px flex-1 bg-border" />
            </div>
