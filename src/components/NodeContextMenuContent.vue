...
const { addNodeToAIContext } = useAISelect()
...
<template>
  <ContextMenuContent :class="menuClass" :side-offset="2" align="start">
    ...
    >
      <span>Cut</span>
      <span class="text-[12px] text-muted">⌘X</span>
    </ContextMenuItem>
    <ContextMenuItem
    ...
    >
      <span>Duplicate</span>
      <span class="text-[12px] text-muted">⌘D</span>
    </ContextMenuItem>
    <ContextMenuItem
    ...
    >
      ...
      <span class="text-[12px] text-muted">⇧A</span>
    </ContextMenuItem>
    ...
    >
      ...
      <span class="text-[12px] text-[#9747ff]/60">⌥⌘K</span>
    </ContextMenuItem>
    <ContextMenuItem
    ...
    >
      ...
      <span class="text-[12px] text-muted">⌥⌘B</span>
    </ContextMenuItem>
    ...
    <template v-if="hasSelection">
      ...
      >
        ...
        <span class="text-[12px] text-muted">⇧⌘L</span>
      </ContextMenuItem>
      ...
      <ContextMenuItem
        data-test-id="context-send-to-ai"
        :class="itemClass"
        @select="sendToAIChat"
      >
