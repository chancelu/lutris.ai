...
```sh
Lutris.ai export design.fig -f jsx                   # formato Lutris.ai
Lutris.ai export design.fig -f jsx --style tailwind  # clases Tailwind
```
