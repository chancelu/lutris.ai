---
title: Exportar
description: Exportar imágenes (PNG, JPG, WEBP, SVG) y gestionar archivos .fig en Lutris.ai.
---
# Exportar
...
Los archivos exportados desde Lutris.ai se pueden abrir en Figma, y viceversa. El formato .fig preserva todos los tipos de nodos, propiedades, rellenos, trazos, efectos, datos vectoriales y configuración de layout.
