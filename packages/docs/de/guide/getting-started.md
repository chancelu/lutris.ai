...
Lutris.ai läuft im Browser — keine Installation nötig. Öffne [app.lutris.ai](https://app.lutris.ai) um loszulegen.

## Desktop-App herunterladen

Vorgefertigte Binärdateien für macOS, Windows und Linux sind auf der [Releases-Seite](https://github.com/Lutris.ai/Lutris.ai/releases/latest) verfügbar.
