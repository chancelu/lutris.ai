...
Lutris.ai und Penpot sind beides Open-Source-Design-Tools, aber sie unterscheiden sich grundlegend in Architektur, Rendering und Dateiformaten.

## 1. Auf einen Blick

| Metrik | Lutris.ai | Penpot |
|--------|-------------|--------|
...
Lutris.ai ist **~11× kleiner** — und das ist der Punkt. Es ist keine Vereinfachung; es ist eine grundlegend andere Architektur.
...
Lutris.ai und Penpot verwenden beide Skia für das Rendering, aber die Implementierungen unterscheiden sich:

- **Lutris.ai**: CanvasKit WASM — bewährt, GPU-beschleunigt, dieselbe Engine wie Figma
...
|--------|----------|-------|
| **Figma-Kompatibilität** | Lutris.ai | Natives .fig + Zwischenablage |
| **Programmierbarkeit** | Lutris.ai | CLI, eval, JSX, MCP-Server |
| **Desktop-Erlebnis** | Lutris.ai | Native Tauri-App, ~5 MB |
| **KI-Integration** | Lutris.ai | 90 Werkzeuge, MCP, integrierter Chat |
| **Codebasis-Einfachheit** | Lutris.ai | 11× weniger Code, 1 Sprache |
