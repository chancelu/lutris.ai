...
```sh
designflow export design.fig                          # PNG (Standard)
designflow export design.fig -f jpg -s 2 -q 90       # JPG in 2×, Qualität 90
designflow export design.fig -f webp -s 3             # WEBP in 3×
designflow export design.fig -f svg                   # SVG-Vektor
```
...
Unterstützt auch `--style designflow` für das native JSX-Format (siehe [JSX-Renderer](../jsx-renderer)).
...
```sh
designflow export -f png    # Screenshot der aktuellen Zeichenfläche
```
