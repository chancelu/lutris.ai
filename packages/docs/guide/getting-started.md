...
Lutris.ai runs in the browser — no installation required. Open [app.lutris.ai](https://app.lutris.ai) to start designing.

## Download Desktop App

Pre-built binaries for macOS, Windows, and Linux are available on the [releases page](https://github.com/Lutris.ai/Lutris.ai/releases/latest).
