...
Lutris.ai funziona nel browser — nessuna installazione richiesta. Apri [app.lutris.ai](https://app.lutris.ai) per iniziare a progettare.

## Scarica l'app desktop

Binari precompilati per macOS, Windows e Linux sono disponibili nella [pagina dei rilasci](https://github.com/Lutris.ai/Lutris.ai/releases/latest).
