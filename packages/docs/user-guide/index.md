...
layout: doc
title: User Guide
description: Learn how to use Lutris.ai — canvas navigation, drawing, text, components, auto-layout, and more.
---

# User Guide

Lutris.ai is an open-source, Figma-compatible design editor — fully local, AI-native, and programmable. This guide covers everything you need to know to use the editor effectively.
