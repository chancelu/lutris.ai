---
title: Context Menu
description: Right-click context menu actions in Lutris.ai — clipboard, z-order, grouping, components, and more.
---
...
- **Copy as JSX** — copies the Lutris.ai JSX representation for use with `renderJsx()`
