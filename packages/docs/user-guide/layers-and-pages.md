---
title: Layers & Pages
description: Managing layers, pages, and the properties panel in Lutris.ai.
---
...
- **Lutris.ai JSX** — custom component tree compatible with `renderJsx()` for programmatic round-trip
