...
const programmableSidebar = (prefix: string, p: ProgrammableLabels): DefaultTheme.SidebarItem[] => [
  ...
  },
  {
    ...
    link: `${prefix}/programmable/image-generation`,
  },
  {
    text: 'PRD to Design',
    link: `${prefix}/programmable/prd-to-design`,
  },
  {
...
const localeThemeConfig = (
  ...
  nav: [
    ...
    { text: nav.openApp, link: 'https://Lutris.ai.dev' },
  ],
  sidebar: {
...
export default defineConfig({
  title: 'Lutris.ai',
  description: 'AI-native design tool. From product requirements to pixel-perfect designs to production code.',
  cleanUrls: true,
  lastUpdated: true,
  appearance: 'dark',
  ...
  sitemap: {
    ...
    transformItems(items) {
      return items.map((item) => {
        const _localeKey = LOCALE_PREFIXES.find((p) => item.url.startsWith(p + '/')) ?? 'en'
        const slug = item.url
  ...
  head: [
    ...
    ['meta', { property: 'og:image:alt', content: 'Lutris.ai — AI-Native Design Tool' }],
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:site', content: '@Lutris.aidev' }],
  ...
  transformPageData(pageData) {
    ...
    if (pageData.title) {
      const ogTitle = `${pageData.title} — Lutris.ai`
  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Open App', link: 'https://Lutris.ai.dev/editor' },
    ],
    ...
    socialLinks: [{ icon: 'github', link: 'https://github.com/Lutris.ai/Lutris.ai' }],

    editLink: {
      pattern: 'https://github.com/Lutris.ai/Lutris.ai/edit/main/packages/docs/:path',
    },
