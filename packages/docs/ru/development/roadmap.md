...
- Идентичность приложения: иконка-карандаш, Cargo crate open_pencil, macOS Dock «Lutris.ai»
...
**Реализовано:**
- @Lutris.ai/core извлечён в packages/core/ (без DOM-зависимостей, Bun workspace)
- @Lutris.ai/cli с headless-операциями над .fig (info, tree, find, export, analyze, node, pages, variables, eval), CPU-растеризация CanvasKit, вывод --json
...
- MCP-сервер (@Lutris.ai/mcp): stdio + HTTP (Hono + Streamable HTTP с сессиями), 87 core-инструментов + 3 инструмента управления файлами (90 всего), работает на Bun и Node.js
...
- Сайт документации VitePress на lutris.ai с i18n (6 языков)
