...
Lutris.ai работает в браузере — установка не требуется. Откройте [app.lutris.ai](https://app.lutris.ai), чтобы начать проектирование.

## Скачать десктоп-приложение

Собранные бинарные файлы для macOS, Windows и Linux доступны на [странице релизов](https://github.com/Lutris.ai/Lutris.ai/releases/latest).
