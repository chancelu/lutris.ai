...
Пофункциональное сравнение возможностей Figma Design с текущим статусом реализации в Lutris.ai.
...
| MCP-сервер | ✅ | @Lutris.ai/mcp с транспортами stdio + HTTP; 87 основных + 3 файловых = 90 инструментов |
