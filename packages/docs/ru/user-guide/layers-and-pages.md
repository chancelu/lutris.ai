...
description: Управление слоями, страницами и панелью свойств в Lutris.ai.
---
...
- **Lutris.ai JSX** — дерево компонентов, совместимое с `renderJsx()` для программного двустороннего преобразования
