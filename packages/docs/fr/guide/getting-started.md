...
Lutris.ai fonctionne dans le navigateur — aucune installation requise. Ouvrez [app.lutris.ai](https://app.lutris.ai).

## Télécharger l'application de bureau

Binaires pour macOS, Windows et Linux sur la [page des versions](https://github.com/Lutris.ai/Lutris.ai/releases/latest).
