...
A detailed architecture and performance comparison document (`COMPARISON.md`, 277 lines) exists in the project root but is not accessible via the VitePress docs site. Users evaluating Lutris.ai vs Penpot have no way to find this content through the documentation.
