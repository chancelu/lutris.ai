...
`COMPARISON.md` in the project root contains an in-depth Lutris.ai vs Penpot comparison: architecture, rendering, data model, layout engine, file format, state management, DX, performance. 10 sections, summary table. Not linked from docs.
