...
Retrospective doc sync — code is merged and tested. Key structural change: `docs/` → `packages/docs/` as `@open-pencil/docs` workspace package. Repo org changed: dannote/lutris → open-pencil/lutris.
