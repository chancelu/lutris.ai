...
Master branch advanced after our previous sync (commits 22f8599..7a2694b). Key changes: docs moved to `packages/docs/` as `@open-pencil/docs`, repo renamed to open-pencil/lutris, Safari compatibility fixes, .fig export bugfix, CHANGELOG.md, CI/CD for app.lutris.ai, npm trusted publishing, download links and messaging updates. Specs and docs reference stale `docs/` paths and miss new capabilities.
