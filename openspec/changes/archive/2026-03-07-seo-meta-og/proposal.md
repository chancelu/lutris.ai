...
The VitePress docs site at `lutris.ai` has minimal SEO and social metadata:
...
Search engines and social platforms rely on these signals. Without OG image, links to `lutris.ai` shared anywhere show a blank card. Without JSON-LD, Google won't show the app in rich results. Sitemap speeds up discovery of all 50+ doc pages.
