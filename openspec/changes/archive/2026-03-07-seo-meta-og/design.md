...
```
https://lutris.ai/                     → EN (root, x-default)
https://lutris.ai/de/                  → DE
https://lutris.ai/fr/                  → FR
https://lutris.ai/es/                  → ES
https://lutris.ai/it/                  → IT
https://lutris.ai/pl/                  → PL
```
...
```ts
['meta', { property: 'og:site_name', content: 'Lutris.ai' }],
['meta', { property: 'og:image', content: 'https://lutris.ai/screenshot.png' }],
['meta', { property: 'og:image:width', content: '2784' }],
['meta', { property: 'og:image:height', content: '1824' }],
['meta', { property: 'og:image:alt', content: 'Lutris.ai — AI-Native Design Editor' }],
['meta', { name: 'twitter:card', content: 'summary_large_image' }],
['meta', { name: 'twitter:site', content: '@openpencildev' }],
['meta', { name: 'twitter:image', content: 'https://lutris.ai/screenshot.png' }],
```
...
transformPageData(pageData) {
  ...
  // og:title (per page)
  if (pageData.title) {
    h.push(['meta', { property: 'og:title', content: `${pageData.title} — Lutris.ai` }])
    h.push(['meta', { name: 'twitter:title', content: `${pageData.title} — Lutris.ai` }])
  }
...
```yaml
title: Lutris.ai — AI-Native Design Editor
```

Locale index files (`de/index.md`, `fr/index.md`, etc.) — add translated `title`:
- DE: `Lutris.ai — KI-nativer Design-Editor`
- FR: `Lutris.ai — Éditeur de Design IA-Natif`
- ES: `Lutris.ai — Editor de Diseño IA-Nativo`
- IT: `Lutris.ai — Editor di Design IA-Nativo`
- PL: `Lutris.ai — Edytor Graficzny z Natywnym AI`
