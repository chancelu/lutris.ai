...
- [x] 1.2 `packages/docs/.vitepress/config.ts` — add `transformPageData` hook that for every page injects into `frontmatter.head`:
  ...
  - `<meta property="og:title">` as `{pageData.title} — Lutris.ai` (when title exists)
...
- [x] 2.1 `packages/docs/.vitepress/config.ts` — add `sitemap: { hostname: 'https://lutris.ai', transformItems }` where `transformItems` adds `links` array with all 6 locale alternates per page URL
...
- [x] 4.1 `packages/docs/index.md` — add `title: Lutris.ai — AI-Native Design Editor` to frontmatter
- [x] 4.2 `packages/docs/de/index.md` — add `title: Lutris.ai — KI-nativer Design-Editor`
- [x] 4.3 `packages/docs/fr/index.md` — add `title: Lutris.ai — Éditeur de Design IA-Natif`
- [x] 4.4 `packages/docs/es/index.md` — add `title: Lutris.ai — Editor de Diseño IA-Nativo`
- [x] 4.5 `packages/docs/it/index.md` — add `title: Lutris.ai — Editor di Design IA-Nativo`
- [x] 4.6 `packages/docs/pl/index.md` — add `title: Lutris.ai — Edytor Graficzny z Natywnym AI`
