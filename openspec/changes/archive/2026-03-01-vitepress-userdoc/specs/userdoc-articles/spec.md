...
The docs site SHALL have an `index.md` at `docs/user-guide/` with the title "User Guide", a brief description of Lutris.ai's capabilities, and links to all user guide articles organized by category.
