...
**Features page**: Add a brief "Why Lutris.ai" intro section before the feature list, derived from README's Why section. Keep concise — 2-3 sentences max, not a copy of the full README section.
