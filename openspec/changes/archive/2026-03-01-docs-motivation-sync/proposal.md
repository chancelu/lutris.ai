...
README gained a "Why" section explaining Lutris.ai's motivation (Figma closing CDP access, supply chain problem, open-source alternative). The docs landing page, comparison page, and features page don't reflect this narrative. The docs still present Lutris.ai generically as "AI-native design editor" without the motivation story.
...
- Update `docs/guide/features.md` to add a "Why Lutris.ai" section at the top, derived from README
