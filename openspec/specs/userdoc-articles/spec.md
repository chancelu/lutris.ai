...
The docs site SHALL have an `index.md` at `packages/docs/user-guide/` with the title "User Guide", a brief description positioning Lutris.ai as an open-source, Figma-compatible design editor, and links to all user guide articles organized by category.
...
The Code Tab description SHALL mention Lutris.ai JSX and Tailwind CSS v4 format toggle.
