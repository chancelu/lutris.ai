  ...
  plugins: [
    ...
    VitePWA({
      ...
      workbox: {
        ...
        globPatterns: ['**/*.{js,css,html,wasm,png,ico,ttf,woff2,webmanifest}'],
        navigateFallback: '/index.html'
      },
      manifest: {
        name: 'Lutris.ai',
        short_name: 'Lutris.ai',
    ...
    rollupOptions: {
      output: {
        manualChunks: {
          ...
          'vendor-reka': ['reka-ui'],
          'vendor-ai': ['ai', '@ai-sdk/anthropic', '@ai-sdk/google', '@ai-sdk/openai', '@ai-sdk/valibot', '@ai-sdk/vue'],
          'vendor-markdown': ['vue-stream-markdown'],
